...
layout = [
    ...
    [sg.Button('Pridėti', size=(15, 1)), sg.Button('Redaguoti', size=(15, 1)),
     ...
     sg.Button('Atkurti iš failo', size=(15, 1)), sg.Button('Duomenų apskaita', size=(15, 1)),
...
while True:
    ...
    if event == sg.WIN_CLOSED or event == 'Išeiti':
        ...
        input_layout = [
    [sg.Text('Data:'), sg.Column([[sg.InputText(key='Data')]], vertical_alignment='center')],
    [sg.Text('Atlikti pratimai:'), sg.Column([[sg.InputText(key='Atlikti pratimai')]], vertical_alignment='center')],
    [sg.Text('Trukmė (min):'), sg.Column([[sg.InputText(key='Trukmė (min)')]], vertical_alignment='center')],
    [sg.Text('Pakartojimų skaičius:'), sg.Column([[sg.InputText(key='Pakartojimų skaičius')]], vertical_alignment='center')],
    [sg.Text('Irankio Svoris (kg):'), sg.Column([[sg.InputText(key='Irankio Svoris (kg)')]], vertical_alignment='center')],
    [sg.Button('Pridėti'), sg.Button('Atšaukti')]
        ...
        if selected_row:
            ...
            edit_layout = [
                ...
                [sg.Text('Svoris (kg):'), sg.InputText(data[selected_row][4], key='Irankio Svoris (kg)')],
